...
(function ($) {
  ...
  $(function() {
    ...
    var colorStatesByDominantEnergy = function (energySourceObj, energyColorObj, statesObj, year) {
    ...
    var dominantWrapper = function (year) {
      var energyObjUpdate = {};
    ...
    var colorStatesChloropleth = function (energyQuantObj, energyChloroplethColorObj, statesObj, year, energyType) {
      var tooltip = d3.select("#map")
      .append("div")
      .attr("id", "pieChartToolTip");
    ...
    var chloroplethWrapper = function (year, energyType, scale) {
     ...
     */
    var displayStatePieChart = function (year, state) {
     ...
     */
    var displayStatePieChartByYear = function (year) {
